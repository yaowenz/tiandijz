$(function(){
	...
	$("#slider_name .silder_nav li").css({"opacity":"1","filter":"alpha(opacity=100)"}).mouseenter(function() {																		
	...
	function showPics(index) {
		...
		$("#slider_name .silder_intro").stop(true,false).animate({"opacity":"1"},300).eq(index).stop(true,false).animate({"opacity":"1"},300);
	}
});